...
/**
 * An object that reads the configs given in <code>configs.sim</code> and
 * executes the corresponding simulations while dumping data for analysis.
 */
public class AutomaticSimulator {

    private Queue<String> configNames = new LinkedList<String>();
     ...
     *
     * @throws FileNotFoundException either if <code>configs.sim</code> could
     *                               not be found or if a configuration
     *                               specified in <code>configs.sim</code> could
     *                               not be found.
     */
