...
phi = PHI;      %Probability of reconnection
...
AA_sp=A_sp;                         %Store A_sp into AA_sp that will be unaffected by the averaging-loop
...
for i=1:ii
    ['Run ', num2str(i),' ...']
    [A_sp, g,t] = simulation(AA_sp, gg, N, M, phi);                     %Return updated connections (A_adj)and opinions (g), always starting from the initial AA-adj and gg!
