...
for NN = [1000]              %Iterate over different system sizes (number of nodes)

    for PHI=[0.9]  %Iterate of different probabilities of reconnection
    %parfor PHI=2:1:3
        %% INITIAL PARAMETERS
        ...
        for i=1:ii
            ...
            [A_sp, g,t] = simulation2(AA_sp, gg, N, phi);                     %Return updated connections (A_adj)and opinions (g), always starting from the initial AA-adj and gg!
