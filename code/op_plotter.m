...
N_range = [500];           %Choose curves to be compared
...
for N = N_range             %Choose curves to be compared
    ...
    gamma = 10;
    ii = 100;
    phi_range = [0.1 0.2 0.225 0.3 0.325 0.35 0.375 0.4 0.425 0.45 0.458 0.475 0.5 0.525 0.55 0.575 0.6:0.1:0.9]; %Explicitly define this vector outside of the for-loop such that it can be used for plotting.
    ...
    for phi=phi_range
        str2=['MULTI_N',num2str(N),'k',num2str(k_avg_set),'gamma',num2str(gamma),'Phi',num2str(phi),'Runs',num2str(ii)];
    ...
    plot(phi_range, op_local, '-o','color',col(i,:)) 
