...
%%  S T A R T V A R I A B L E N
Player_1 = 0.3;     %Risikobereitschaft P1
Player_2 = 0.6;     %Risikobereitschaft P2

BetValue = 1;       %Einsatz

StartKapital = 12;   %Startkapital

CreditP1 = StartKapital;
CreditP2 = StartKapital;
